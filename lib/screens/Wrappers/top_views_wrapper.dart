...
class TopViewsWrapper extends ConsumerStatefulWidget {
  final bool shouldKeepAlive;
  final Widget child;

  const TopViewsWrapper({
    Key? key,
  ...
  @override
  ConsumerState createState() => _TopViewsWrapperState();
}

class _TopViewsWrapperState extends ConsumerState<TopViewsWrapper>
  ...
  Widget build(BuildContext context) {
    ...
    } else if (ref.watch(viewProvider) == 2) {
