...
class CardSliderWrapper extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _CardSliderWrapperState();
}

class _CardSliderWrapperState
    extends ConsumerState<CardSliderWrapper>
  ...
  Widget build(BuildContext context) {
    ...
    if (ref.watch(viewProvider) == 1) {
      animationController.forward();
    } else if (ref.watch(viewProvider) != 1) {
